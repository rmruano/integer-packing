...
class IntegerPairTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testEncodeDecodeValid(){
        $validData = array(
            array(20, 30),
            array(0, IntegerPair::MAX_32BIT_INTEGER_VALUE),
            array(IntegerPair::MAX_32BIT_INTEGER_VALUE, 0),
            array(IntegerPair::MAX_32BIT_INTEGER_VALUE, IntegerPair::MAX_32BIT_INTEGER_VALUE),
        );
    ...
    public function testOutOfBounds() {
        $validData = array(
            array(-1, IntegerPair::MAX_32BIT_INTEGER_VALUE+1),
            array(IntegerPair::MAX_32BIT_INTEGER_VALUE+1, -1),
            array(-1, 0, 0, 0),
            array(0, -1, 0, 0),
        );
        foreach ($validData as $i=>$data) {
