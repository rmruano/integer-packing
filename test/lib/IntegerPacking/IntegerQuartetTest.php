...
class IntegerQuartetTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testEncodeDecodeValid(){
        $validData = array(
            array(20, 30, 40, 50),
            array(-20, -30, -40, -50),
            array(-(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1), IntegerQuartet::MAX_16BIT_INTEGER_VALUE, -(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1), IntegerQuartet::MAX_16BIT_INTEGER_VALUE),
            array(IntegerQuartet::MAX_16BIT_INTEGER_VALUE, -(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1), IntegerQuartet::MAX_16BIT_INTEGER_VALUE, -(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1)),
        );
    ...
    public function testOutOfBounds() {
        $validData = array(
            array(-(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1)-1, IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1, -(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1)-1, IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1),
            array(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1, -(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1)-1, IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1, -(IntegerQuartet::MAX_16BIT_INTEGER_VALUE+1)-1),
        );
        foreach ($validData as $i=>$data) {
            try {
                new IntegerQuartet($data[0], $data[1], $data[2], $data[3]);
